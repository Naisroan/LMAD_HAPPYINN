<%@ Page 
    ...
    Inherits="NDEV_HAPPY_INN.mods.clientes" 
...
<asp:Content ID="c_styles" ContentPlaceHolderID="cph_styles" runat="server">
    ...
    <link type="text/css" rel="stylesheet" href="<%: ResolveUrl("~/Content/mods/clientes/clientes.css") %>" />
</asp:Content>
...
<asp:Content ID="c_scripts" ContentPlaceHolderID="cph_scripts" runat="server">
    ...
    <link type="text/css" rel="stylesheet" href="<%: ResolveUrl("~/Content/mods/clientes/clientes.js") %>" />
</asp:Content>
                    ...
                    <div class="d-block mb-4">
                        ...
                        >
                            <Columns>
                                ...
                                <asp:BoundField DataField="tel_casa" HeaderText="Casa" />
                                <asp:BoundField DataField="tel_celular" HeaderText="Celular" />
                                <asp:BoundField DataField="domicilio" HeaderText="Domicilio" />
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox
                                        ...
                                        TextMode="MultiLine"
                                        Rows="3"
                                        placeholder="¿Dónde se enteró de Happy Inn?" />
                                </div>
