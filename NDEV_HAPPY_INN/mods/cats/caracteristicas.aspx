<%@ Page 
    ...
    Inherits="NDEV_HAPPY_INN.mods.cats.caracteristicas" 
...
<asp:Content ID="c_styles" ContentPlaceHolderID="cph_styles" runat="server">
    ...
    <link type="text/css" rel="stylesheet" href="<%: ResolveUrl("~/Content/mods/cats/caracteristicas/caracteristicas.css") %>" />
</asp:Content>
...
<asp:Content ID="c_scripts" ContentPlaceHolderID="cph_scripts" runat="server">
    ...
    <link type="text/css" rel="stylesheet" href="<%: ResolveUrl("~/Content/mods/cats/caracteristicas/caracteristicas.js") %>" />
</asp:Content>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Pensada para</label>
                                    <asp:DropDownList
                                        ID="ddlTipo"
                                        runat="server"
                                        CssClass="custom-select"
                                    >
                                        <asp:ListItem Selected="True" Text="Tipo de caracteristica" Value="-1" />
                                        <asp:ListItem Text="Hotel" Value="Hotel" />
                                        <asp:ListItem Text="Habitación" Value="Habitación" />
                                        <asp:ListItem Text="Ambas" Value="Ambas" />
                                    </asp:DropDownList>
                                </div>
