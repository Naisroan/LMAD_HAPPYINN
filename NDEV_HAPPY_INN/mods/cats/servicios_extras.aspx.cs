...
{
    public partial class servicios_extras : HappyInnPage
    {
        #region "CONSTANTES"
        ...
        private List<Servicio_Extra> Lista
        {
            get => (List<Servicio_Extra>)Session["Lista"];
        ...
        protected async void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Lista = (await Servicio_ExtraMap.ReadAllAsync()).ToList();
            }
        ...
        protected async void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Servicio_Extra nodo = null;

                if (nuevo)
                {
                    nodo = LlenarNodo();
                    await Servicio_ExtraMap.Create(nodo);
                }
                else
                {
                    nodo = LlenarNodo(Servicio_ExtraMap.Read(hfId.Value));
                    await Servicio_ExtraMap.Update(nodo);
                }
        ...
        protected async void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                await Servicio_ExtraMap.Delete(await Servicio_ExtraMap.ReadAsync(hfId.Value));
        ...
        protected void gridView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Servicio_Extra registroSeleccionado = Servicio_ExtraMap.Read(dataKey);
        ...
        protected Servicio_Extra LlenarNodo(Servicio_Extra nodo = null)
        {
            if (nodo == null)
            {
                return new Servicio_Extra()
                {
            ...
            else
            {
                ...
                nodo.precio = Convert.ToDecimal(txtPrecio.Text);
        ...
        protected void LlenarCampos(Servicio_Extra nodo)
        {
            try
            {
                ...
                txtPrecio.Text = Convert.ToString(nodo.precio);
